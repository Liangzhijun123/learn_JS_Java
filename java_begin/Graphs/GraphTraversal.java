...
class UnweightedGraph {
   ...
   private LinkedList<Integer> adj[]; // adjacency list for each node. array adj of linkedlist of integers. 
   
   UnweightedGraph(int numNodes, char[] nodeNames) {
      N = numNodes; //how many nodes in the graph
      adj = new LinkedList[N]; // create an adjacency list for each node. give me N number of linkeslist
      names = new char[N]; // names of each nodes. empty character array of N elements
