...
channel.onmessage = (event) => {
  ...
  if (event.data === "data-updated") {
    // update th eUI or perform other actions
  ...
  getAllJokes()
    .then((jokes) => {
      ...
      if (jokes.length > 0) {
        ...
        //clear the list of past jokes since we are going to re-render it
        jokeList.innerHTML = "";
        ...
        // loop over each jokes and render it
        jokes.array.forEach((joke) => {
